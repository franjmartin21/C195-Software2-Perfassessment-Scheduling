...
public class SchedulingException extends Exception {
    ...
    public enum SchedulingExceptionTypeEnum {
        ...
        START_APPOINTMENT_DATE_NOT_INFORMED,
        START_APPOINTMENT_DATE_INVALID,
        START_APPOINTMENT_TIME_NOT_INFORMED,
        START_APPOINTMENT_TIME_NOT_INVALID,
        END_APPOINTMENT_DATE_NOT_INFORMED,
        END_APPOINTMENT_DATE_INVALID,
        END_APPOINTMENT_TIME_NOT_INFORMED,
        END_APPOINTMENT_TIME_NOT_INVALID,
